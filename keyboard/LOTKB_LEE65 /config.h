...
#define PRODUCT "LOTKB BLE 65" /* 硬件名称，用于USB和蓝牙显示 */
...
// 启用 LED 状态灯
// 3灯指示配置引脚
// #define LED_STATUS_BLE 5
// #define LED_STATUS_CHARGING 7
...
//#define UARxT_DET 19 // UART 检测引脚，若此脚被拉低，则说明USB正在工作。若不配置则使用RX口作为检测引脚
